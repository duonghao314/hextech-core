...
# hextech_core/
APPS_DIR = ROOT_DIR / "hextech_core"
env = environ.Env()
...
MIGRATION_MODULES = {"sites": "hextech_core.contrib.sites.migrations"}
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            ...
            "context_processors": [
                ...
                "hextech_core.utils.context_processors.settings_context",
            ],
        },
    }
]
...
ADMINS = [("""DuongHao314""", "nhatquang.nv14@gmail.com")]
...
# https://django-allauth.readthedocs.io/en/latest/configuration.html
ACCOUNT_ADAPTER = "hextech_core.users.adapters.AccountAdapter"
# https://django-allauth.readthedocs.io/en/latest/configuration.html
SOCIALACCOUNT_ADAPTER = "hextech_core.users.adapters.SocialAccountAdapter"
# django-compressor
# ------------------------------------------------------------------------------
...
WAGTAIL_SITE_NAME = "Hextech Core"
